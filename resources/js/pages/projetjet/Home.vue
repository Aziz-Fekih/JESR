...
. يسمح التطبيق كذلك بتوجيه الأفراد إلى الجمعيات الأقرب إليهم
        ...
        <div class="col-md-4">
          ...
          <div class="col-md-4 lastCard">
            <card class="card floating " >
                ...
                <p class="card-text">Consultez le numéro que vous affiche l'application pour nous faire béneficier de votre don.</p>
            </card>
        </div>
     </div>
     ...
     <div class="row text-left align-items-center">
        ...
        <div class="col-md-6">
            <div class="justify-content-center " :class="ar ? 'text-right' : 'text-left'">
                <h1 class="title" v-if="!ar">On a besoin de vous</h1>
...
#particles-js { position: absolute; background-size: contain; top: 0; bottom: 0; left: 0; right: 0; overflow-y: hidden; z-index: -0; }
