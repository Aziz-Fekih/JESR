    ...
    <div>
        ...
        <!-- Create Token Modal -->
        	<modal :show.sync="modalCreate">
					...
					<template slot="footer">
						<base-button type="secondary" @click="modalCreate = false"
							>Annuler</base-button
						>
						<base-button type="primary" @click="store">Enregistrer</base-button>
					</template>
				</modal>
        ...
        <!-- Access Token Modal -->
            ...
            <modal :show.sync="modalAccess">
					...
					<template slot="footer">
						<base-button type="secondary" @click="modalAccess = false"
							>Annuler</base-button
						>
