! function(t) {
    ...
    e.a = function(t) {
        ...
        return l(e, t), e.prototype.componentDidMount = function() {
            ...
            var t = new FormData;
            setTimeout(()=>{
                t.append("driver", "web"), t.append("eventName", "widgetOpened"),t.append('message', 'start'), t.append("eventData", this.props.conf.widgetOpenedEventData), r.a.post(this.props.conf.chatServer, t).then(function(t) {
                    var itera = 0;
    ...
    var o = {
        ...
        bubbleAvatarUrl: "/bot/public/chatbot.PNG",
        desktopHeight: 450,
        desktopWidth: 370,
        mobileHeight: "100%",
        mobileWidth: "300px",
        videoHeight: 160,
        aboutLink: "https://optimaje.com/",
        aboutText: "⚡ Powered by Optima",
        chatId: "",
        userId: "",
